...
ActiveRecord::Schema[8.1].define(version: 2026_07_10_214557) do
  ...
  create_table "classrooms", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.date "date_enrollment"
    t.text "description", null: false
    t.date "end_date", null: false
    t.string "name", null: false
    t.bigint "professor_id", null: false
    t.boolean "self_enrollment", default: false, null: false
    t.date "start_date", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "exercises", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.boolean "visible_by_other_professors", default: true, null: false
  ...
  create_table "submissions", force: :cascade do |t|
    ...
    t.boolean "passed"
    t.string "status"
    t.text "structured_packet_captures"
